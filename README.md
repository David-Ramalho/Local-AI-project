...
1. 🔧 Install Docker Desktop
 ...
 3. 🤖 Spin Up Ollama as an HTTP Service
   This command runs Ollama and makes it available as an API:   
           ...
           docker run -d --name ollama-server --restart always --gpus all -p 11434:11434 -v ollama-data:/root/.ollama -e OLLAMA_HOST="0.0.0.0:11434" -e OLLAMA_FLASH_ATTENTION=1 -e OLLAMA_KV_CACHE_TYPE=q4_0 -e OLLAMA_NUM_GPU=999 ollama/ollama:latest serve
